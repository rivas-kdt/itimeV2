...
export default function InspectPage() {
    ...
    console.log(`/api/v2/inspections?wo=${workOrderId}&wc=${workCodeId}&ci=${constructionItemId}&o=${othersId}&own=true`)
    ...
    const { recordsInfo } = useTimerHooks(workOrderId, workCodeId, constructionItemId, othersId)
