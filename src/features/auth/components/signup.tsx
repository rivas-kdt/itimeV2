...
export function SignUpForm({ onChangeView }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (password !== confirmPassword) {
      ...
      toastError(isMobile, "Validation Error", "Passwords do not match");
      return;
    }
      ...
      <div className="flex flex-col p-8 gap-10">
        <div className=" h-full">
          ...
          <p className=" mt-2 text-gray-500 text-md">
            Create your account for easy inspection tracking, real-time
            insights, and clear reporting.
          </p>
          {formError && (
  ...
  return (
    <div className=" flex flex-col gap-2 w-full p-8">
      <div className=" h-full">
        ...
        <p className=" mt-2 text-gray-500 text-md">
          Create your account for easy inspection tracking, real-time insights,
          and clear reporting.
        </p>
        {formError && (
