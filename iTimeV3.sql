...
ALTER TABLE IF EXISTS ONLY public.inspection DROP CONSTRAINT IF EXISTS inspection_work_id_fkey;
ALTER TABLE IF EXISTS ONLY public.inspection DROP CONSTRAINT IF EXISTS inspection_location_id_fkey;
ALTER TABLE IF EXISTS ONLY public.inspection DROP CONSTRAINT IF EXISTS inspection_inspector_id_fkey;
ALTER TABLE IF EXISTS ONLY public."group" DROP CONSTRAINT IF EXISTS group_dept_id_fkey;
ALTER TABLE IF EXISTS ONLY public.inspection_v2 DROP CONSTRAINT IF EXISTS fk_work_order_id;
ALTER TABLE IF EXISTS ONLY public.inspection_v2 DROP CONSTRAINT IF EXISTS fk_work_code_id;
ALTER TABLE IF EXISTS ONLY public.inspection_v2 DROP CONSTRAINT IF EXISTS fk_others_id;
ALTER TABLE IF EXISTS ONLY public.inspection_v2 DROP CONSTRAINT IF EXISTS fk_location_id;
ALTER TABLE IF EXISTS ONLY public.inspection_v2 DROP CONSTRAINT IF EXISTS fk_inspector_id;
ALTER TABLE IF EXISTS ONLY public.inspection_v2 DROP CONSTRAINT IF EXISTS fk_construction_item_id;
ALTER TABLE IF EXISTS ONLY public.employee DROP CONSTRAINT IF EXISTS employee_group_id_fkey;
DROP INDEX IF EXISTS public.idx_inspection_work_id;
DROP INDEX IF EXISTS public.idx_inspection_location_id;
DROP INDEX IF EXISTS public.idx_inspection_inspector_id;
DROP INDEX IF EXISTS public.idx_group_dept_id;
DROP INDEX IF EXISTS public.idx_employee_group_id;
ALTER TABLE IF EXISTS ONLY public.work_order DROP CONSTRAINT IF EXISTS work_order_work_order_work_code_key;
ALTER TABLE IF EXISTS ONLY public.work_order_v2 DROP CONSTRAINT IF EXISTS work_order_v2_pkey;
ALTER TABLE IF EXISTS ONLY public.work_order DROP CONSTRAINT IF EXISTS work_order_pkey;
ALTER TABLE IF EXISTS ONLY public.work_code DROP CONSTRAINT IF EXISTS work_code_pkey;
ALTER TABLE IF EXISTS ONLY public.others DROP CONSTRAINT IF EXISTS others_pkey;
ALTER TABLE IF EXISTS ONLY public.location_v2 DROP CONSTRAINT IF EXISTS location_v2_pkey;
ALTER TABLE IF EXISTS ONLY public.location DROP CONSTRAINT IF EXISTS location_pkey;
ALTER TABLE IF EXISTS ONLY public.location DROP CONSTRAINT IF EXISTS location_location_key;
ALTER TABLE IF EXISTS ONLY public.inspection_v2 DROP CONSTRAINT IF EXISTS inspection_v2_pkey;
...
ALTER TABLE IF EXISTS ONLY public."group" DROP CONSTRAINT IF EXISTS group_group_name_key;
ALTER TABLE IF EXISTS ONLY public.employee DROP CONSTRAINT IF EXISTS employee_pkey;
ALTER TABLE IF EXISTS ONLY public.employee DROP CONSTRAINT IF EXISTS employee_email_key;
ALTER TABLE IF EXISTS ONLY public.department DROP CONSTRAINT IF EXISTS department_pkey;
ALTER TABLE IF EXISTS ONLY public.department DROP CONSTRAINT IF EXISTS department_dept_name_key;
ALTER TABLE IF EXISTS ONLY public.construction_item DROP CONSTRAINT IF EXISTS construction_item_pkey;
DROP TABLE IF EXISTS public.work_order_v2;
DROP TABLE IF EXISTS public.work_order;
DROP TABLE IF EXISTS public.work_code;
DROP TABLE IF EXISTS public.others;
DROP TABLE IF EXISTS public.location_v2;
DROP TABLE IF EXISTS public.location;
DROP TABLE IF EXISTS public.inspection_v2;
